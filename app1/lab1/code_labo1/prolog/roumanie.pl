...
% Date: 2010-08-31
% Donn�es pour la carte de la Roumanie, selon le livre de
% de Russel et Norvig, 3e �dition, pages 68 et 93 

% Repr�sentation de la fonction successeur S(n)
...
% Distance � vol d'oiseau de Bucharest: heuristique h(n)
